...
function Recipe() {
  ...
  const YOUR_APP_ID = "34f668d8";
  const YOUR_APP_KEY = "caeec21cecebc0681a9968eff0a06f28";
      ...
      <div className="recipe_App">
        <h1
          style={{
            fontSize: "52px",
            textAlign: "center",
            fontFamily: "Chronicle Deck,Times,serif",
          }}
        >
          Explore Our Meal Delivery Menus
        </h1>
        ...
        <p style={{ marginTop: "25px" }}>
          Choose from an ever-changing mix of meat, fish, and health-conscious
          offerings.
        </p>
